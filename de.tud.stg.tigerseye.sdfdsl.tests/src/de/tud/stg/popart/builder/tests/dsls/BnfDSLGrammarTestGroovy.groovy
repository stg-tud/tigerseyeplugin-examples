...
////				)
////			] as BnfDSL.Rule[])
//			//TODO: This test does not run in Groovy (but runs in Java), because Groovy 1.7 does not support casting to inner classes (e.g. as BnfDSL.Term[])!
//		}
//		
...
//	
////	@Test
////	@Ignore("This test does not run in Groovy (but runs in Java), because Groovy 1.7 does not support casting to inner classes (e.g. as BnfDSL.Term[])!")
////	public void testFoo() {

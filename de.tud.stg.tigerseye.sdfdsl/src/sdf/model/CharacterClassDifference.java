 ...
 *
 */
public class CharacterClassDifference extends CharacterClass {

	CharacterClass left;
	CharacterClass right;

	public CharacterClassDifference(CharacterClass left,
			CharacterClass right) {
		super();
		this.left = left;
		this.right = right;
	...
	public CharacterClassDifference(CharacterClass left, CharacterClass right, String label) {
		this(left, right);
		this.setLabel(label);
	}
